...
Cách 2 (nếu có git): `git clone https://github.com/IoeCmcomc/wplace_scraper.git`
...
* `PIXEL_TILE_URL_PATTERN`: nếu bạn muốn cào openplace.live hoặc 1 website khác chạy trên nền [openplace](https://github.com/openplaceteam/openplace), hãy thay đổi hằng xâu này trỏ vào địa chỉ tương ứng.
